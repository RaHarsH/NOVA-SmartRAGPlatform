      ...
      <div
        className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 ${
          isDragOver
            ...
            : uploadedFile
            ? "border-violet-500 bg-violet-400/10"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Button
                  ...
                  className="cursor-pointer bg-gradient-to-r from-blue-600 to-violet-700 hover:from-blue-700 hover:to-violet-800"
                >
            ...
            <div className="space-y-4">
              ...
              {uploadedFile.status === "uploading" && (
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-blue-600 to-violet-700 h-2 rounded-full transition-all duration-300"
